<?php
    ...
    $resultContacts = mysqli_query($conn,$sqlContacts) or die ("hihi");

    if ($resultContacts) 
    {
        $rows = mysqli_num_rows($resultContacts);
        if ($rows == 0)
        {
            $resultContacts = 0;
        }
...
<head>
    ...
    <meta name="description" content="Fashion MyLiShop - fashion mylishop - Đây là trang quản lý mylishop's shop">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;     background: #2b3643; border-color: #2b3643">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style="margin-top: -15px;"><img src="../images/logohong.png" alt="" width="150px;" height="52px;"></a>
            </div>
            <!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
                <li><!-- Danh sách liên hệ -->
                    <a href="contact-new.php" title="Danh sách liên hệ mới"> <i class="fa fa-envelope-o" aria-hidden="true" style="font-size: 20px;"></i>
                ...
                <li><!-- Đơn đặt hàng mới -->
                    <a href="neworder.php" title="Đơn đặt hàng mới"> <i class="fa fa-building" style="font-size: 20px;"></i>
                        <div class="top-message">
                            <?php
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="logout.php"><i class="fa fa-sign-out fa-lg"></i> Đăng xuất </a></li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                <!-- /.Admin-->
